        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.Order)
                    ...
                    .HasConstraintName("FK__OrderDeta__Order__7D0E9093");

                entity.HasOne(d => d.PizzaCust)
                    .WithMany(p => p.OrderDetail)
                    .HasForeignKey(d => d.PizzaCustId)
                    .HasConstraintName("FK__OrderDeta__pizza__7C1A6C5A");
            });
            ...
            modelBuilder.Entity<Orders>(entity =>
            {
                ...
                entity.Property(e => e.OrderPlaced).HasMaxLength(25);
            ...
            modelBuilder.Entity<ShoppingCartItem>(entity =>
            {
                ...
                entity.HasOne(d => d.PizzaCust)
                    ...
                    .HasConstraintName("FK__ShoppingC__pizza__607251E5");
            });
